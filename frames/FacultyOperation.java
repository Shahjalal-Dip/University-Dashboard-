...
import entities.*;
import repositories.*;
public class FacultyOperation extends JFrame implements ActionListener
{
	...
	public FacultyOperation(User u)
	{
		super("Faculty Operation Frame");
        ...
        this.updateBtn.setBounds(60,510,80,30);
        this.updateBtn.setBackground(Color.BLUE);
