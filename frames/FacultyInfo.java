...
public class FacultyInfo extends JFrame implements ActionListener{
    ...
    private String []col={"Faculty ID","Name","Email","Phone Number","Gender","Age","Address","Date of Birth","NID no"};
    private String [][]row;
    private User u;
    public FacultyInfo(String [][]row,User u) {
        this.row=row;
        this.u=u;
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        this.setTitle("Faculty Information List ");
    ...
    public void initComponents(){
        ...
        this.l1=new JLabel("Faculty Information");
        ...
        this.sp.setBounds(20,80,750,330);
        this.c.add(sp);
        this.c.revalidate();
        this.c.repaint();
